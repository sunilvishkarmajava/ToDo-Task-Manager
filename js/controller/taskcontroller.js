...
taskList.forEach(function(taskObject){
    ...
    li.innerHTML=taskObject.id+" "+taskObject.name+" "+taskObject.desc+" "+duedate;
    ul.appendChild(li);
...
function addNewTask(){
    ...
    var li = document.createElement("li");
    li.className="pending";
    taskOperations.addTask(taskName,taskDesc,duedate);
    li.innerHTML=taskOperations.taskId+" "+taskName+" "+taskDesc+" "+duedate;
    ul.appendChild(li);
    li.addEventListener("click",toggleTask);
    updateCount();
